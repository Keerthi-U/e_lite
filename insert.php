...
$bank_attachment=$_FILES['bank_attachment']['tmp_name'];
...
echo $query = "INSERT into `scholarship_table`(`fullname`,`dob`,`gender`,`fathername`,`mothername`,`contactnumber`,`address`,`email`,`city`,`district`,`state`,`school_name`,`reg_no`,`department`,`school_address`,`mark_percentage`,`previous_marksheet`,`term_semester`,`academic_year`,`scholarship_select`,`phone_no`,`student_email`,`account_no`,`bank_name`,`ifsc_code`,`aadhar_number`,`bank_attachment`,`hospital_name`,`disease_select`,`severity_disease`,`admission_date`,`approximate_expense`,`request_amount`,`hospital_report`,`previous_medical_report,`insurance_scheme`,`guardian_name`,`created_at,updated_at`) VALUES ('$fullname','$dob','$gender','$fathername','$mothername','$contactnumber','$address','$email','$city','$district','$state','$school_name','$reg_no','$department','$school_address','$mark_percentage','$previous_marksheet','$term_semester','$academic_year','$scholarship_select','$phone_no','$student_email','$account_no','$bank_name','$ifsc_code','$aadhar_number','$bank_attachment','$hospital_name','$disease_select','$severity_disease','$admission_date','$approximate_expense','$request_amount','$hospital_report','$previous_medical_report','$insurance_scheme','$government','$private','$guardian_name','$created_at','$updated_at')";
